...
struct Post {
    ...
    init(title: String, image: String, owner: String, date: Date, description: String, tags: [String : Bool], receivedRequests: [String: [String: Bool]], isProject: Bool, isStudy: Bool, members: String) {
        self.title = title
        self.image = image
        self.owner = owner
        self.date = date
